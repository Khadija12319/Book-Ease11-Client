...
const NavBar = () => {
  ...
  const navEnd =<>
            ...
            <div>
            <button type="button" onClick={toggleDropdown} className="inline-flex w-full justify-center gap-x-1.5 bg-white px-3 py-2 text-sm font-semibold text-gray-900 tooltip tooltip-left dark:bg-transparent z-10" id="menu-button" aria-expanded="true" aria-haspopup="true" data-tip={user?.displayName}>
            { user?.photoURL ? (
    ...
    return (
        <div>
            <div>
                <div>
                <div className="navbar lg:px-20 flex md:flex-row flex-col py-4 relative z-10">
                <div className="navbar-start md:w-[50%] w-[100%] relative z-10">
